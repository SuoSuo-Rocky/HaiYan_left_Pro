...
public partial class up_add : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        conn.Open();
        int up_num = Convert.ToInt32(Request.QueryString["up_num"]) + 1;
        

        // 查询当前的 赞数
        sql01 = sql01 +  " up=" + "'" + Convert.ToString(up_num) + "'";
        Response.Write("id ------>" + Request.QueryString["id"]);
        Response.Write("up------>" + Convert.ToString(up_num));
