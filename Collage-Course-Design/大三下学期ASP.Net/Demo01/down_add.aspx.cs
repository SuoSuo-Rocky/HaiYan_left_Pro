...
public partial class down_add : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        conn.Open();
        int down_num = Convert.ToInt32(Request.QueryString["down_num"]) + 1;


        // 查询当前的 赞数
        sql01 = sql01 + " down=" + "'" + Convert.ToString(down_num) + "'";
        Response.Write("id ------>" + Request.QueryString["id"]);
        Response.Write("up------>" + Convert.ToString(down_num));
