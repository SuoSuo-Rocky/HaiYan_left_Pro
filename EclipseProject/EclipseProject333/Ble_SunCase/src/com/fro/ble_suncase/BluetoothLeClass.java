...
public class BluetoothLeClass {
	...
	private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
		...
		public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
			Log.d("shi","----------public void onConnectionStateChange-------------"+Thread.currentThread().getName());
		...
		public void onServicesDiscovered(BluetoothGatt gatt, int status) {
			Log.d("shi","----------public void onServicesDiscovered-------------"+Thread.currentThread().getName());
		...
		@Override
		public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
			Log.d("shi","------------public void onCharacteristicRead-----------"+Thread.currentThread().getName());
		...
		public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
			Log.d("shi","------public void onCharacteristicChanged(-----------------"+Thread.currentThread().getName());
			if (mOnDataAvailableListener != null)
	...
	public boolean initialize() {
		Log.d("shi","----------public boolean initialize()-------------"+Thread.currentThread().getName());
	...
	public boolean connect(final String address) {
		Log.d("shi","----------public boolean connect(f-------------"+Thread.currentThread().getName());
	...
	public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
		Log.d("shi","----------public void readCharacteristic(-------------"+Thread.currentThread().getName());
		if (mBluetoothAdapter == null || mBluetoothGatt == null) {
			Log.i(TAG, "BluetoothAdapter not initialized");
			return;
		}
	...
	public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic, boolean enabled) {
		Log.d("shi","---------public void setCharacteristicNotification--------------"+Thread.currentThread().getName());
		if (mBluetoothAdapter == null || mBluetoothGatt == null) {
			Log.i(TAG, "BluetoothAdapter not initialized");
			return;
		}
	...
	public void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
		Log.d("shi","----------public void writeCharacteristic(BluetoothGattCharacteristic characteristic)------"+Thread.currentThread().getName());
