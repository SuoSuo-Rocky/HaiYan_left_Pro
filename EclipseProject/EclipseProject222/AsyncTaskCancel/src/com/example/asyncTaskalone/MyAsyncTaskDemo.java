...
public class MyAsyncTaskDemo extends AsyncTask<String ,Integer,byte[]> {
  ...
  public MyAsyncTaskDemo(Context context,ImageView view) {
	...
	protected void onPreExecute() {
		System.out.println("djfkjfga");
		Log.i("shi","onPreExecute:Thread:"+Thread.currentThread().getName() );
	...
	protected void onCancelled() {
		Log.i("shi","onCancelled:Thread:"+Thread.currentThread().getName() );
		pd.dismiss();
	...
	protected void onPostExecute(byte[] result) {
		Log.i("shi","onPostExecute:Thread:"+Thread.currentThread().getName() );
